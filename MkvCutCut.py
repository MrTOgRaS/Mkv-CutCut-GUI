...
LANGS = {
    "English": {
        "app_title":       "🎬 MKV CutCut",
        "developer_info":  "Developer: MrTOgRaS  ·  mkvmerge Powered  ·  v1.0",
        ...
        "log_welcome":     "MKV CutCut v2.2 started. Welcome!",
    ...
    "Türkçe": {
        "app_title":       "🎬 MKV CutCut",
        "developer_info":  "Geliştirici: MrTOgRaS  ·  mkvmerge Destekli  ·  v1.0",
        ...
        "log_welcome":     "MKV CutCut v2.2 başlatıldı. Hoş geldiniz!",
    ...
    "Deutsch": {
        "app_title":       "🎬 MKV CutCut",
        "developer_info":  "Entwickler: MrTOgRaS  ·  mkvmerge Powered  ·  v1.0",
        ...
        "log_welcome":     "MKV CutCut v2.2 gestartet. Willkommen!",
...
# ─── ABOUT PENCERESI (HİÇBİR YERİ KIRPILMAMIŞ TAM SÜRÜM) ───────────────────────
def show_about(root, colors):
    ...
    hdr.pack(fill="x")
    tk.Label(hdr, text="🎬 MKV CutCut  v1.0",
...
class MKVCutCut:
    def __init__(self, root):
        self.root = root
        self.root.title("🎬 MKV CutCut v1.0")
